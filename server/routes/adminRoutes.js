...
const { getUsers, runDraw, getAllScores, adminDeleteScore, createCharity, adminDeleteCharity, verifyWinner, getWinners, getReports, getDraws } = require("../controllers/adminController");
const { protect, admin } = require("../middleware/authMiddleware");

router.route("/users").get(protect, admin, getUsers);
router.route("/draws").post(protect, admin, runDraw).get(protect, admin, getDraws);
