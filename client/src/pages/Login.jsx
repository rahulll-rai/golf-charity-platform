...
const Login = () => {
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4 bg-[#022c22]">
      <motion.div 
      ...
      >
        <div className="absolute -top-20 -right-20 w-48 h-48 bg-amber-500/10 rounded-full blur-[50px] pointer-events-none" />
        
        <div className="text-center mb-8 relative z-10">
          <h2 className="text-3xl font-bold mb-2 text-white">Welcome Back</h2>
          <p className="text-emerald-200/60">Sign in to access your dashboard</p>
        </div>
        ...
        <div className="mt-6 text-center text-sm text-emerald-200/60 relative z-10">
          Don't have an account? <Link to="/register" className="text-amber-400 hover:text-amber-300 font-bold transition-colors">Sign up</Link>
        </div>
      </motion.div>
    </div>
  );
